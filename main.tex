...
\icmlauthor{Marco Carraro}{}
\icmlauthor{Francesco Vezzani}{}
\end{icmlauthorlist}
...
\begin{itemize}
    ...
    \item \textbf{Reusable package}: \texttt{dart\_rl} provides \texttt{LinearThompsonSampling}, \texttt{ContextualBanditArm}, and \texttt{ContextualBanditRanking}.
